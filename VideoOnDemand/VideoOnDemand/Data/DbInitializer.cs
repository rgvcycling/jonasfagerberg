...
namespace VideoOnDemand.Data
{
    public class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            {
                new Instructor { Name = "Ray Garza", Description = "Very awesome guy, loves to cycle and help others.", Thumbnail = "/images/Ice-Age-Scrat-icon.png" },
                new Instructor { Name = "Aby Hererra", Description = "Bright, inteligent, and eager to assist you in anything you need!", Thumbnail = "/images/Ice-Age-Scrat-icon.png" }
            };
